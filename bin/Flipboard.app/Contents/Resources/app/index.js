...
var fs = require("fs");
var initPath, data, savedWidth, savedHeight, splashWindow, mainWindow, statusWindow, isOnline;
...
app.on('ready', function () {
  ...
  mainWindow.webContents.on('did-finish-load', function (event, oldUrl, newUrl, isMainFrame) {
      if (isOnline) {
